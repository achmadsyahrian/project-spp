        ...
        <div class="main">
            ...
            <div class="row">
              <?php foreach($bulan as $row) : ?>
                <?php 
                  $bln = $row['nama_bulan']; 
                  $statusBayar = query(" SELECT * FROM transaksi WHERE bulan_bayar = '$bln' AND kode_tahun_ajaran = '$kodeThnAjar' AND kode_siswa = '$kodeSiswa'  ");
                  if (count($statusBayar) > 0) {
                    $statusBayar = $statusBayar[0];
                  } else {
                    $statusBayar = null;
                  }
                ?>
                ...
                <div class="col-sm-4">
                  <div class="card animate__animated animate__fadeInUp animate__fast">
                    <?php if($statusBayar !== null && $statusBayar['status'] == "Lunas") { ?>
                        ...
                        <div class="col mt-0">
                          <?php 
                            if ($statusBayar !== null) {?>
                              ...
                              <?php } ?>
                            <?php } else {
                              echo "<h1 class='card-title text-danger' style='font-size:18px;'>".$row['nama_bulan']."</h1>";
                            } ?>
                        </div>
                        <div class="col-auto">
                          <div class="stat-danger">
                            ...
                            <?php } elseif($statusBayar !== null && $statusBayar['status'] == "Proses") { ?>
