								...
								<div class="card flex-fill">
									<table class="table table-hover my-0  table-responsive">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="number" name="totalBiaya" id="totalBiaya" class="form-control" style="width:400px;" value="<?= $tahunAjaran['biaya_semester']; ?>" readonly>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>:</td>
											<td>
												<input type="number" min="1000" max="<?= $tahunAjaran['biaya_semester']; ?>" name="totalBayar" id="totalBayar" class="form-control" style="width:400px;" value="<?= $transaksi['total_bayar']; ?>" required > 
											</td>
										</tr>
									</table>
								</div>
