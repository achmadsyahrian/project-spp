										...
										<div class="card animate__animated animate__fadeInUp animate__fast">
											<div class="card-body">
												...
												<div class="mb-0 disable">
													<a class="more-dashboard" href="user-account"><span class=" text-more-dashboard text-primary">More Info</span>
									...
									<div class="col-sm-8">
										<div class="card animate__animated animate__fadeInUp animate__fast">
												<div class="card-body">
													...
													<div class="mb-0 disable">
														<a class="more-dashboard" href="data-siswa"><span class=" text-more-dashboard text-primary">More Info</span>
															<i class="align-middle" data-feather="arrow-right-circle"></i>
														</a>
													</div>
												</div>
