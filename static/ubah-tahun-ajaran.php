								...
								<div class="card flex-fill">
									<table class="table table-hover my-0  table-responsive">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="number" name="biayaSemester" id="biayaSemester" class="form-control" style="width:400px;" value="<?= $tahunAjar["biaya_semester"]; ?>" required oninvalid="this.setCustomValidity('Biaya Semester harus diisi..')" oninput="setCustomValidity('')"> 
											</td>
										</tr>
									</table>
								</div>
